...
mixin _$ChatState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MessageEntity> messages, bool isTyping)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MessageEntity> messages, bool isTyping)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<MessageEntity> messages, bool isTyping});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<MessageEntity> messages, this.isTyping = false})
      : _messages = messages;
